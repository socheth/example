            ...
            <div id="hs-header-classic"
                ...
                <div
                    ...
                    <div class="py-2 md:py-0 flex flex-col md:flex-row md:items-center md:justify-end gap-0.5 md:gap-1">
                        <a class="flex items-center p-2 text-sm text-blue-600 focus:outline-none focus:text-blue-600 dark:text-blue-500 dark:focus:text-blue-500"
                        ...
                        <a class="flex items-center p-2 text-sm text-gray-800 hover:text-gray-500 focus:outline-none focus:text-gray-500 dark:text-neutral-200 dark:hover:text-neutral-500 dark:focus:text-neutral-500"
                            href="#">
                            <svg class="block shrink-0 size-4 me-3 md:me-2 md:hidden" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div
                            ...
                            <button id="hs-header-classic-dropdown" type="button"
                                class="flex items-center w-full p-2 text-sm text-gray-800 hs-dropdown-toggle hover:text-gray-500 focus:outline-none focus:text-gray-500 dark:text-neutral-200 dark:hover:text-neutral-500 dark:focus:text-neutral-500"
                        ...
                        <div
                            ...
                            <a class="flex items-center w-full p-2 text-sm text-gray-800 hover:text-gray-500 focus:outline-none focus:text-gray-500 dark:text-neutral-200 dark:hover:text-neutral-500 dark:focus:text-neutral-500"
                                href="#">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <div class="hs-dropdown [--placement:top-left] relative inline-flex">
                        <button id="hs-footer-language-dropdown" type="button"
                            ...
                            aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            <svg class="rounded-full shrink-0 size-3" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <g fill-rule="evenodd">
                                        <g stroke-width="1pt">
                                            <path fill="#bd3d44"
                                                d="M0 0h247v10H0zm0 20h247v10H0zm0 20h247v10H0zm0 20h247v10H0zm0 20h247v10H0zm0 20h247v10H0zm0 20h247v10H0z"
                                                transform="scale(3.9385)" />
                                            <path fill="#fff" transform="scale(3.9385)" />
                                            d="M0 10h247v10H0zm0 20h247v10H0zm0 20h247v10H0zm0 20h247v10H0zm0
