<x-guest-layout>
    <x-slot name="headerTitle">400 - Unsupported Request</x-slot>
    <div class="max-w-[50rem] flex flex-col mx-auto size-full">

        <!-- ========== MAIN CONTENT ========== -->
        <main id="content">
            <div class="px-4 py-10 text-center sm:px-6 lg:px-8">
                <h1 class="block font-bold text-gray-800 text-7xl sm:text-9xl dark:text-white">400</h1>
                <p class="mt-3 text-gray-600 dark:text-neutral-400">Oops, something went wrong.</p>
                <p class="text-gray-600 dark:text-neutral-400">Sorry, Unsupported.</p>
