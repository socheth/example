<section>
    ...
    <form method="post" action="{{ route('admin.profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="name" name="name" type="text" class="block w-full mt-1 border" :value="old('name', $user->name)"
        ...
        <div>
            ...
            <x-text-input id="email" name="email" type="email" class="block w-full mt-1 border"
        ...
        <div class="flex items-center gap-4">
            ...
            @if (session('status') === 'profile-updated')
                <p x-data="{ show: true }" x-show="show" x-transition x-init="setTimeout(() => show = false, 2000)" class="text-green-500 ">
                    {{ __('Saved.') }}</p>
            @endif
        </div>
    </form>
