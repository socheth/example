<x-guest-layout>
    <x-slot name="headerTitle">Registered</x-slot>
    <div class="max-w-[50rem] flex flex-col mx-auto size-full">

        <!-- ========== MAIN CONTENT ========== -->
        <main id="content">
            <div class="px-4 py-10 text-center sm:px-6 lg:px-8">
                <h1 class="block text-5xl text-green-500">Registered</h1>
                <p class="mt-3 text-gray-600 dark:text-neutral-400">Check your email and verify your account.</p>
                <p class="text-gray-600 dark:text-neutral-400">Welcome, {{ auth()->user()->name }}</p>
